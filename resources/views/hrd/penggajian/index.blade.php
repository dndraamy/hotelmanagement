...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border p-6">
        ...
        <form action="{{ route('hrd.penggajian.generate') }}" method="POST" class="flex flex-col md:flex-row gap-4 items-end">
            @csrf
    ...
    <div class="bg-white rounded-2xl shadow-sm border p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <form action="{{ route('hrd.penggajian.index') }}" method="GET" class="flex gap-2">
                    ...
                    @forelse($riwayatGaji as $gaji)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="p-4 text-center">
                                <a href="{{ route('hrd.penggajian.cetak', $gaji->id_penggajian) }}" target="_blank" class="bg-blue-100 text-blue-700 hover:bg-blue-200 px-3 py-1.5 rounded-lg text-xs font-semibold inline-flex items-center gap-1">
                                    Cetak Slip
                                </a>
                            </td>
                        </tr>
